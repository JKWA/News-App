...
export class NewsService {
  ...
  /**
   * Http operation to get article data.
   * Let the app continue.
   * @param category - Category enum to set sources
   * @param pageNumber - page number of return results
   * @param filters - Set of filter values
   */
  getNews (
    category: Category,
    pageNumber: number,
    filters: Set<Filter> ): Observable<Article[]> {
